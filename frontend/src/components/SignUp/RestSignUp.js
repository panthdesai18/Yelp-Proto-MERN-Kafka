            ...
            <div>
                ...
                <div>
                    <div class = "column" style ={{ textAlign : "center", width : "600", height: "auto", paddingTop: 30}}>   
                        <div>
                            <h2 class = "signinh3" > Sign Up for Yelp Business</h2>
                            <br></br>
                        ...
                        <div>
                            <Form>
                                <Form.Row>
                                    ...
                                    <Form.Control type="text" placeholder="Restaurant Name" onChange = {this.restnameChangeHandler} style ={{width:300, height:25 }}/>
                                    </Form.Group>
                                </Form.Row>
...
function mapDispatchToProps(dispatch){
    return{
        restsignUp: user => dispatch(restsignUp(user))
    };
}
...
const RestauSignUp = connect(mapStateToProps, mapDispatchToProps)(RestSignUp);
export default RestauSignUp;
