...
class UpdateRestPhotoThree extends Component {
    photoChange = (event) => {
        ...
        axios.post(`${connURL}/updateRestPhotoThree`,formData, config)
                .then(response => {
    ...
    submitGetCreatedEvents = (e) => {
        this.props.history.push("/updateRestPhoto4")
    }
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <Button onClick = {this.submitGetCreatedEvents} style={{marginLeft:0, borderRadius:5, backgroundColor:"#d32323",width:188, height:40, marginTop:10, color:"white", fontWeight:"bold"}}>Add 4th Photo</Button>
...
export default UpdateRestPhotoThree
