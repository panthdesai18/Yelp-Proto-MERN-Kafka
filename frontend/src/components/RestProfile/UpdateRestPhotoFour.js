...
class UpdateRestPhotoFour extends Component {
    photoChange = (event) => {
        ...
        axios.post(`${connURL}/updateRestPhotoFour`,formData, config)
                .then(response => {
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <Button style={{marginLeft:0, borderRadius:5, backgroundColor:"#d32323",width:288, height:40, marginTop:10, color:"white", fontWeight:"bold"}}>Cannot Add More Photo After This</Button>
...
export default UpdateRestPhotoFour
